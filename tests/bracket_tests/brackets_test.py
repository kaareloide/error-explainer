...
class BracketsTest(unittest.TestCase):
    ...
    def test_missing_bracket_after(self):
        ...
        expected_message = self.message_provider.get_formatted_message("missing_brackets.normal.closing",
                                                                       count=1, line=2)
    ...
    def test_miss_matched_bracket_types(self):
        ...
        expected_message = self.message_provider.get_formatted_message("miss_matched_brackets.square.normal", line=2)
    ...
    def test_missing_brackets_print(self):
        ...
        expected_message = self.message_provider.get_formatted_message("missing_brackets.print", line=2)
    ...
    def test_missing_square_bracket_after(self):
        ...
        expected_message = self.message_provider.get_formatted_message("missing_brackets.square.closing",
                                                                       count=1, line=5)
