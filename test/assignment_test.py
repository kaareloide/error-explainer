...
class AssignmentTest(unittest.TestCase):
    def test_assignment_to_keyword(self):
        ...
        expected_message = get_formatted_message(
            "invalid_assignment", statement="None = 1", line=1
        )
    ...
    def test_assignment_to_function(self):
        ...
        expected_message = get_formatted_message(
            "invalid_assignment", statement="f() = 1", line=4
        )
        run_test_scenario(self, path, 1, expected_message)
    ...
    def test_assignment_to_expr(self):
        ...
        expected_message = get_formatted_message(
            "invalid_assignment", statement="a + 1 = 2", line=1
        )
        run_test_scenario(self, path, 1, expected_message)
    ...
    def test_assignment_to_variable_1(self):
        ...
        expected_message = get_formatted_message(
            "invalid_assignment", statement='"abc" = 1', line=1
        )
        run_test_scenario(self, path, 1, expected_message)
    ...
    def test_assignment_to_variable_2(self):
        ...
        expected_message = get_formatted_message(
            "invalid_assignment", statement="3 = 1", line=1
        )
        run_test_scenario(self, path, 1, expected_message)
    ...
    def test_assignment_to_variable_3(self):
        ...
        expected_message = get_formatted_message(
            "invalid_assignment", statement="True = 1", line=1
        )
        run_test_scenario(self, path, 1, expected_message)
    ...
    def test_multiple(self):
        ...
        expected_messages = [
            get_formatted_message("invalid_assignment", statement="True = 1", line=1),
    ...
    def test_comparison_assignment(self):
        path = "assignment_samples/comparison_assignment_correct.py"
        expected_message = get_formatted_message(
    ...
    def test_tuple_assignment(self):
        path = "assignment_samples/tuple_assign_correct.py"
        expected_message = get_formatted_message(
            "missing_brackets.normal.closing", count=1, line=1
        )
        run_test_scenario(self, path, 1, expected_message)
